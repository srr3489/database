...
START TRANSACTION;
USE `equipment_inventory`;
INSERT INTO `equipment_inventory`.`role` (`id`, `role`, `display_name`, `status`) VALUES (1, 'ROLE_STUDENT', 'Student', 'A');
INSERT INTO `equipment_inventory`.`role` (`id`, `role`, `display_name`, `status`) VALUES (2, 'ROLE_FACULTY', 'Faculty', 'A');
INSERT INTO `equipment_inventory`.`role` (`id`, `role`, `display_name`, `status`) VALUES (3, 'ROLE_LAB_ASSISTANT', 'Lab Assistant', 'A');
INSERT INTO `equipment_inventory`.`role` (`id`, `role`, `display_name`, `status`) VALUES (4, 'ROLE_ADMIN', 'Admin', 'A');
